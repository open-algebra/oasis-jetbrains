...
public class PALMOperandImpl extends ASTWrapperPsiElement implements PALMOperand {

  public PALMOperandImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PALMExpression getExpression() {
    return findChildByClass(PALMExpression.class);
  }
